...
public:
    CustomChordContainerComponent(ProjectManager * pm)
    {
        ...
        for (int i = 0; i < 12; i++)
        {
            noteComponent[i] = std::make_unique<CustomChordNoteComponent>(i, projectManager);
...
public:
    CustomChordPopupComponent(ProjectManager * pm)
    {
        ...
        customChordContainerComponent = std::make_unique<CustomChordContainerComponent>(projectManager);
