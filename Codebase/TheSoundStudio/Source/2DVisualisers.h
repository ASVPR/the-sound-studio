...
// C++17: Replace macro with constexpr for better type safety
constexpr int RING_BUFFER_READ_SIZE = 256;

class OpenGLOscilloscope :  public Component,
                            public OpenGLRenderer
{
public:
    
    OpenGLOscilloscope (RingBuffer<GLfloat> * ringBuffer)
